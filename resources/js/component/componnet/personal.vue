<template>
    <div class="card">
        ...
        <div class="card-body py-3">
            <div>
                <form id="form_6">
                    <div class="row">
                        <div class="col-lg-6 col-12 fv-row mb-7 fv-plugins-icon-container">
                            <label class="required  fs-6 fw-semibold mb-2">Email:</label>
                            <input type="text" v-bind:value="user['email']"
                                   class="form-control disabled form-control-solid"
                                   placeholder="Write Your Email" disabled name="email">
                            <div
                                class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                        <div class="col-lg-6 col-12 fv-row mb-7 fv-plugins-icon-container">
                            <label class="required  fs-6 fw-semibold mb-2">Mailing:</label>
                            <input type="text" v-bind:value="user['mailing']"
                                   class="form-control  form-control-solid"
                                   placeholder="Write Your Mailing" name="mailing">
                            <div class="fv-plugins-message-container invalid-feedback" id="mailing"></div>
                        </div>
                    </div>
                    <div class="row">
                        <div id="emergency_div" class="col-lg-6 col-12 fv-row mb-7 fv-plugins-icon-container">
                            <label for="phone" class=" fs-6 fw-semibold mb-2">Emergency
                                Contact:</label>
                            <input type="text"
                                   class="form-control form-control-solid" v-bind:value="user['emergency']"
                                   placeholder="Write Your Emergency Contact" name="emergency">
                            <div class="fv-plugins-message-container invalid-feedback" id="emergency"></div>

                        </div>
                        <div id="phone_div" class="col-lg-6 col-12 fv-row mb-7 fv-plugins-icon-container">
                            <label for="phone" class="required fs-6 fw-semibold mb-2">Phone
                                Number:</label>
                            <input id="phone" type="text" v-bind:value="user['phoneNumber']"
                                   class="form-control form-control-solid "
                                   placeholder="Write Your Email" name="phoneNumber">
                            <div class="fv-plugins-message-container invalid-feedback" id="phoneNumber"></div>
                    ...
                    <div id="address_div" class="fv-row mb-15">
                        ...
                        <input id="address" type="text" v-bind:value="user['address']"
                               class="form-control form-control-solid "
                    ...
                    <div class="row">
                        <div id="given_name_div" class="col-lg-6 col-12 fv-row mb-7 fv-plugins-icon-container">
                            <label class="required fs-6 fw-semibold mb-2">Given
                                Name:</label>
                            <input type="text" class="form-control form-control-solid"
                                   placeholder="Write Your Email" name="givenName" v-bind:value="user['givenName']">
                            <div class="fv-plugins-message-container invalid-feedback" id="givenName"></div>
                        ...
                        <div id="middle_name_div"
                            ...
                            <input type="text"
                                   class="form-control form-control-solid" v-bind:value="user['middleName']"
                                   placeholder="Write Your Email" name="middleName">
                            <div class="fv-plugins-message-container invalid-feedback" id="middleName"></div>
                    ...
                    <div class="fv-row mb-7 fv-plugins-icon-container" id="family_div">
                        ...
                        <input type="text" v-bind:value="user['familyName']"
                               class="form-control form-control-solid"
                               placeholder="Write Your Address" name="familyName">
                        <div class="fv-plugins-message-container invalid-feedback" id="familyName"></div>
                    ...
                    <div class="fv-row mb-7  fv-plugins-icon-container" id="birth_day_div">
                        ...
                        <div class="position-relative d-flex align-items-center ">
                            ...
                            <input v-bind:value="user['birthDate']"
                                   class="form-control d-block form-control-solid"
                                   style="padding-left: 35px"
                                   placeholder="Pick date range" name="birthDate"
                                   type="date">
                            <!--                            <div class="fv-plugins-message-container invalid-feedback" id="birthDate"></div>-->
                            <br>

                        </div>
                        <div class="fv-plugins-message-container invalid-feedback d-block" id="birthDate"></div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12 fv-row mb-7 fv-plugins-icon-container">
                            ...
                            <input type="text" class="form-control form-control-solid"
                                   v-bind:value="user['passportNumber']" placeholder="Write Your Passport Number"
                                   name="passportNumber">
                            <div class="fv-plugins-message-container invalid-feedback" id="passportNumber"></div>

                        </div>
                        <div
                            class="fv-row col-lg-6 col-12 mb-7 fv-plugins-icon-container">
                            <label class="fs-6 required fw-semibold mb-2">Passport Expiry Date:</label>
                            <div class="position-relative d-flex align-items-center ">
                                                    <span class="svg-icon svg-icon-2 position-absolute mx-4"><svg
                                                        xmlns="http://www.w3.org/2000/svg" width="24"
                                                        height="24"
                                                        ...
                                                        d="M8.8 13.1C9.2 13.1 9.5 13 9.7 12.8C9.9 12.6 10.1 12.3 10.1 11.9C10.1 11.6 10 11.3 9.8 11.1C9.6 10.9 9.3 10.8 9 10.8C8.8 10.8 8.59999 10.8 8.39999 10.9C8.19999 11 8.1 11.1 8 11.2C7.9 11.3 7.8 11.4 7.7 11.6C7.6 11.8 7.5 11.9 7.5 12.1C7.5 12.2 7.4 12.2 7.3 12.3C7.2 12.4 7.09999 12.4 6.89999 12.4C6.69999 12.4 6.6 12.3 6.5 12.2C6.4 12.1 6.3 11.9 6.3 11.7C6.3 11.5 6.4 11.3 6.5 11.1C6.6 10.9 6.8 10.7 7 10.5C7.2 10.3 7.49999 10.1 7.89999 10C8.29999 9.90003 8.60001 9.80003 9.10001 9.80003C9.50001 9.80003 9.80001 9.90003 10.1 10C10.4 10.1 10.7 10.3 10.9 10.4C11.1 10.5 11.3 10.8 11.4 11.1C11.5 11.4 11.6 11.6 11.6 11.9C11.6 12.3 11.5 12.6 11.3 12.9C11.1 13.2 10.9 13.5 10.6 13.7C10.9 13.9 11.2 14.1 11.4 14.3C11.6 14.5 11.8 14.7 11.9 15C12 15.3 12.1 15.5 12.1 15.8C12.1 16.2 12 16.5 11.9 16.8C11.8 17.1 11.5 17.4 11.3 17.7C11.1 18 10.7 18.2 10.3 18.3C9.9 18.4 9.5 18.5 9 18.5C8.5 18.5 8.1 18.4 7.7 18.2C7.3 18 7 17.8 6.8 17.6C6.6 17.4 6.4 17.1 6.3 16.8C6.2 16.5 6.10001 16.3 6.10001 16.1C6.10001 15.9 6.2 15.7 6.3 15.6C6.4 15.5 6.6 15.4 6.8 15.4C6.9 15.4 7.00001 15.4 7.10001 15.5C7.20001 15.6 7.3 15.6 7.3 15.7C7.5 16.2 7.7 16.6 8 16.9C8.3 17.2 8.6 17.3 9 17.3C9.2 17.3 9.5 17.2 9.7 17.1C9.9 17 10.1 16.8 10.3 16.6C10.5 16.4 10.5 16.1 10.5 15.8C10.5 15.3 10.4 15 10.1 14.7C9.80001 14.4 9.50001 14.3 9.10001 14.3C9.00001 14.3 8.9 14.3 8.7 14.3C8.5 14.3 8.39999 14.3 8.39999 14.3C8.19999 14.3 7.99999 14.2 7.89999 14.1C7.79999 14 7.7 13.8 7.7 13.7C7.7 13.5 7.79999 13.4 7.89999 13.2C7.99999 13 8.2 13 8.5 13H8.8V13.1ZM15.3 17.5V12.2C14.3 13 13.6 13.3 13.3 13.3C13.1 13.3 13 13.2 12.9 13.1C12.8 13 12.7 12.8 12.7 12.6C12.7 12.4 12.8 12.3 12.9 12.2C13 12.1 13.2 12 13.6 11.8C14.1 11.6 14.5 11.3 14.7 11.1C14.9 10.9 15.2 10.6 15.5 10.3C15.8 10 15.9 9.80003 15.9 9.70003C15.9 9.60003 16.1 9.60004 16.3 9.60004C16.5 9.60004 16.7 9.70003 16.8 9.80003C16.9 9.90003 17 10.2 17 10.5V17.2C17 18 16.7 18.4 16.2 18.4C16 18.4 15.8 18.3 15.6 18.2C15.4 18.1 15.3 17.8 15.3 17.5Z"
                                                        fill="black"></path></svg></span>
                                <input v-bind:value="user['expiryDate']"
                                       class="form-control form-control-solid"
                                       style="padding-left: 35px"
                                       name="expiryDate"
                                       type="date">
                            ...
                            <div class="fv-plugins-message-container invalid-feedback" id="expiryDate"></div>
                    ...
                    <div class="fv-row mb-7 fv-plugins-icon-container" id="country">
                        <label class="fs-6 required fw-semibold mb-2">Country of
                            Citizenship</label>
                        <select v-bind:value="user['countryCitizenship']"
                                class="form-control form-control-solid"
                                name="countryCitizenship">
                            <option v-bind:selected="user['country']=='Canada'?'selected':''">Canada</option>
                            <option v-bind:selected="user['country']=='USA'?'selected':''">USA</option>
                            <!--                                                    <option {{$user['country']==$c['name']?'selected':''}} >{{$c['name']}}</option>-->

                        </select>
                        <div class="fv-plugins-message-container invalid-feedback" id="countryCitizenship"></div>
                    ...
                    <div class="fv-row mb-15 mt-5" id="gender_div">
                        ...
                        <input v-bind:checked="user['gender']==='male'" id="male" checked
                        ...
                        <input v-bind:checked="user['gender']==='female'" id="female" style="margin-right: 3px;"
                        ...
                        <input v-bind:checked="user['gender']==='other'" style="margin-right: 3px;" id="other"
                               class="form-check-input "
                               type="radio"
                    ...
                    <button type="button" style="float:  right"
                            @click="saveParent(['address','phoneNumber','mailing','emergency','address','middleName','givenName','familyName',
                            'birthDate','countryCitizenship','gender','passportNumber','expiryDate'
                            ],6)"
    ...
    <div v-if="comment !=null&&comment.length!=0" class="card card-flush mb-6 mb-xl-9 mt-10" id="kt_chat_messenger">
        <!--begin::Card header-->
...
A
        ...
        <div class="card-footer pt-4" id="kt_chat_messenger_footer">
            ...
            <div class="d-flex flex-stack">
                ...
                <!--end::Actions-->
                <!--begin::Send-->
                <button @click="storeComment(6)" class="btn btn-primary" type="button"
...
export default {
    ...
    mounted() {
        ...
        Echo.channel('new-comment').listen('NewComment', (e) => {
            if (e.comment['to_user'] === this.user['id']) {
