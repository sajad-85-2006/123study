                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                        ...
                                        <div class="px-7 py-5">
                                            ...
                                            <div id="div-1" class="mb-10">
                                                <label class="form-label fw-semibold">Status:</label>
                                                @foreach($steps as $step)
                                                    @if(\App\Models\User::query()->where('id',$request['user_id'])->first()['status_request']<=$step['id_step'])
        ...
        function update_request(id, id_request, kay) {
            ...
            xml.onload = function () {
                ...
                if (json[0] == '200') {
                    ...
                    json[2].map(function (item, index) {
                        ...
                        console.log(document.getElementById(item_1 + '-label'))
            ...
            if (document.getElementsByName('step')) {
                ...
                for (let x = 1; x <= document.getElementsByName('step').length; x++) {
                    console.log('step-' + x + '=' + document.getElementsByName('step')[x - 1].value + '@' + document.getElementsByName('step')[x - 1].checked + '&')
