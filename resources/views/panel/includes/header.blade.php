    ...
    <div class="container-xxl d-flex align-items-center flex-lg-stack">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-2 me-lg-5">
            ...
            <!--end::Aside toggle-->
                <!--begin::Header Logo-->
                <a href="/">
                    <img alt="Logo" src="/assets/img/logo.svg" class="h-30px h-lg-35px "/>
                </a>
                <!--end::Header Logo-->
            </div>
            <!--end::Wrapper-->
                                ...
                                <div class="scroll-y mh-200px mh-lg-350px">
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <img src="/assets/Panel/media/avatars/300-6.jpg" alt=""/>
                                        </div>
                                        <!--end::Symbol-->
                                        <!--begin::Title-->
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="/assets/Panel/media/avatars/300-2.jpg" alt=""/>
                                        </div>
                                        <!--end::Symbol-->
                                        <!--begin::Title-->
                                        <div class="d-flex flex-column justify-content-start fw-semibold">
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="/assets/Panel/media/avatars/300-9.jpg" alt=""/>
                                        </div>
                                        <!--end::Symbol-->
                                        <!--begin::Title-->
                                        <div class="d-flex flex-column justify-content-start fw-semibold">
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="/assets/Panel/media/avatars/300-14.jpg" alt=""/>
                                        </div>
                                        <!--end::Symbol-->
                                        <!--begin::Title-->
                                        <div class="d-flex flex-column justify-content-start fw-semibold">
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="/assets/Panel/media/avatars/300-11.jpg" alt=""/>
                                        </div>
                                        <!--end::Symbol-->
                                        <!--begin::Title-->
                                        <div class="d-flex flex-column justify-content-start fw-semibold">
                                        ...
                                        <div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
																	<img class="w-20px h-20px"
                                                                         src="/assets/Panel/media/svg/brand-logos/volicity-9.svg"
                                                                         alt=""/>
																</span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        ...
                                        <div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
																	<img class="w-20px h-20px"
                                                                         src="/assets/Panel/media/svg/brand-logos/tvit.svg"
                                                                         alt=""/>
																</span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        ...
                                        <div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
																	<img class="w-20px h-20px"
                                                                         src="/assets/Panel/media/svg/misc/infography.svg"
                                                                         alt=""/>
																</span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        ...
                                        <div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
																	<img class="w-20px h-20px"
                                                                         src="/assets/Panel/media/svg/brand-logos/leaf.svg"
                                                                         alt=""/>
																</span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        ...
                                        <div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
																	<img class="w-20px h-20px"
                                                                         src="/assets/Panel/media/svg/brand-logos/tower.svg"
                                                                         alt=""/>
																</span>
                                        </div>
                                        <!--end::Symbol-->
            ...
            @cannot('admin')
                ...
                <div class="app-navbar-item ms-1 ms-lg-3">
                    ...
                    <div onclick="show()"
                        ...
                        <!--end::Svg Icon-->
                        @if(\App\Models\Message::query()->where('to_user',\Illuminate\Support\Facades\Auth::id())->where('status','false')->first())
                            <span id="alarm" class="bullet bullet-dot bg-success h-6px w-6px position-absolute translate-middle top-0 start-50 animation-blink"></span>
                        @endif
                    </div>
                    <!--end::Menu wrapper-->
                </div>
                        ...
                        <div class="menu-item px-3">
                            <a href="/panel/profile">
                                ...
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <!--begin::Username-->
                                    <div class="d-flex flex-column">
                                        <div class="fw-bold d-flex align-items-center fs-5 text-gray-800">{{$user['name']}}
                                            @if(\App\Models\Requst::query()->where('user_id',\Illuminate\Support\Facades\Auth::id())->first('status_request'))
                                                <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{\App\Models\Requst::query()->where('user_id',\Illuminate\Support\Facades\Auth::id())->first('status_request')['status_request']}}</span>
                                            @endif
                                            @can('admin')
                    ...
                    <div class="menu-item px-5">
                        <form action="{{route('logout')}}" method="post">
                            <div class="menu-item px-5 my-1">
                                @csrf
                                <button
                                    style="background: none;border: none;padding: 0!important;font-weight: 500!important;"
                                    class="menu-link px-5">Log out
                                </button>
                            </div>
                        </form>
                    </div>
...
@cannot('admin')
    ...
    <div id="kt_drawer_chat" class="bg-body " data-kt-drawer="true" data-kt-drawer-name="chat"
        ...
        <!--begin::Messenger-->
        <div id="load123" style="z-index: 10;opacity: 75%;transition: 1s" class="position-fixed w-100 h-100 bg-black ">
            <div class="text-center">
                <div style="    text-align: center;
    top: 300px;
    position: absolute;
    left: 231px;width: 3rem; height: 3rem;" class="spinner-border text-danger" role="status">
        ...
        <div class="card w-100 rounded-0 border-0" id="kt_drawer_chat_messenger">
            ...
            <div class="card-header pe-5" id="kt_drawer_chat_messenger_header">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex justify-content-center flex-column me-3">
                        ...
                        <!--begin::Info-->
                        <div class="mb-0 lh-1">
                            <span class="fs-7 fw-semibold text-muted">Immigration Expert</span>
                        </div>
                        <!--end::Info-->
                    </div>
                    <!--end::User-->
            ...
            <div class="card-body" id="kt_drawer_chat_messenger_body">
                ...
                <div id="message" class="scroll-y me-n5 pe-5" data-kt-element="messages" data-kt-scroll="true"
                     data-kt-scroll-activate="true" data-kt-scroll-height="auto"
                     data-kt-scroll-dependencies="#kt_drawer_chat_messenger_header, #kt_drawer_chat_messenger_footer"
                     data-kt-scroll-wrappers="#kt_drawer_chat_messenger_body" data-kt-scroll-offset="0px">
                    <div class="d-flex justify-content-start mb-10" id="0">
                        <div class="d-flex flex-column align-items-start">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="ms-3">
                                    <a class="fs-5 fw-bold text-gray-900 text-hover-primary me-1">Admin</a>
                                    <span id="time" class="text-muted fs-7 mb-1">now</span>
                                </div>
                            </div>
                            <div
                                class="p-5 rounded bg-light-info text-dark fw-semibold mw-lg-400px text-start&quot; data-kt-element=&quot;message-text">
                                Hello
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-footer pt-4" id="kt_drawer_chat_messenger_footer">
                <!--begin::Input-->
                <textarea id="text" class="form-control form-control-solid mb-3" rows="3" data-kt-element="input"
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--end::Actions-->
                    <!--begin::Send-->
                    <a onclick="store()" class="btn btn-primary hover-elevate-up" data-kt-element="send">Send</a>
                    <!--end::Send-->
                </div>
                <!--end::Toolbar-->
            </div>
    ...
    <div class="position-fixed bottom-0 end-0 p-3 z-index-3">
        <div id="kt_docs_toast_toggle" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
                ...
                <strong id="name" class="me-auto"> Admin
                </strong>
                <small>11 mins ago</small>
                <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
            </div>
            <div id="tost" class="toast-body">
    ...
    <script>
        ...
        function show() {
            let xmlChat = new XMLHttpRequest()
            xmlChat.onload = function () {
                let json = JSON.parse(this.responseText)
                let ch = document.getElementById('message')

                json.map(function (item, index) {
                    if (!document.getElementById(index)) {
                        if (item['from_user'] === Number(id)) {
                            ...
                            let text_span_3 = document.createTextNode('Y')
            ...
            xmlChat.open('POST', '/api/get-message-user')
            xmlChat.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
            xmlChat.send('id={{\Illuminate\Support\Facades\Auth::id()}}')

            let xmlUpdate = new XMLHttpRequest()
            xmlUpdate.onload = function () {

            }
            xmlUpdate.open('POST', '/api/update-status')
            xmlUpdate.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
            xmlUpdate.send('id={{\Illuminate\Support\Facades\Auth::id()}}')
            if(document.getElementById('alarm')){
                document.getElementById('alarm').style.display='none'
            }
            setTimeout(function () {
                document.getElementById('load123').style.opacity=0
                let ch1 = document.querySelector('#message')

                ch1.scrollTop = parseInt(ch1.scrollHeight);
            },1000)
            setTimeout(function () {
                document.getElementById('load123').style.display='none'
            },2000)
        }

        let idch='{{\Illuminate\Support\Facades\Auth::id()}}';

        function listen() {
            Echo.channel('message-chat').listen('NewMessage', (e) => {
                let ch = document.getElementById('message')
                console.log([idch,e.message['to_user']])

                if (e.message['to_user'] == idch) {
                    ...
                    this.message_new = e.message
                    document.getElementById('tost').innerHTML=e.message['message']
                    toast.show();
                    let div = document.createElement('div')
                    let child_1 = ch.appendChild(div)
                    child_1.className = 'd-flex justify-content-start mb-10'
                    ...
                    let child_8 = child_2.appendChild(div_5)
                    child_8.className = 'p-5 rounded bg-light-info text-dark fw-semibold mw-lg-400px text-start" data-kt-element="message-text'
                    let divtext = document.createTextNode(e.message['message'])
                    child_8.appendChild(divtext)
                    let ch1 = document.querySelector('#message')
        ...
        function store() {
            ...
            xmlChat.onload = function () {
                ...
                // let child_8 = child_2.appendChild(div_5)
                // child_8.className = 'p-5 rounded bg-light-primary text-dark fw-semibold mw-lg-400px text-end" data-kt-element="message-text'
                // let divtext = document.createTextNode(document.getElementById('text').value)
                // child_8.appendChild(divtext)
                show()
            }
            xmlChat.open('POST', '/api/store-message')
            xmlChat.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
            xmlChat.send('from_user={{\Illuminate\Support\Facades\Auth::id()}}&to_user=0&message=' + document.getElementById('text').value)
    ...
    <div class="position-fixed bottom-0 end-0 p-3 z-index-3">
        <div id="kt_docs_toast_toggle" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
                ...
                <strong class="me-auto" id="name">
                </strong>
                <small>now</small>
                <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
            </div>
            <div class="toast-body" id="tost">
            </div>
        </div>
    </div>
        ...
        setTimeout(function () {
            Echo.channel('message-chat').listen('NewMessage', (e) => {
                ...
                if (e.message['to_user'] == 0) {
                    ...
                    document.getElementById('name').innerHTML = e.user['name']
                    document.getElementById('profile').innerHTML = e.user['name'][0]
                    document.getElementById('tost').innerHTML = e.message['message']
